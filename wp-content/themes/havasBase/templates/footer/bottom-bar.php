	...
	<div class="wf-wrap">
		...
		<div class="wf-container-bottom">
			...
			<div class="wf-table wf-mobile-collapsed">
				...
				<style>
						.jhavasfooter { position:absolute;top:20px;left:50%;transform:translate(-50%,0); }
						@media screen and (max-width:1120px){
						.jhavasfooter { position:static; display:block; margin:auto; padding-bottom: 10px; width:100%; max-width:340px;transform:translate(0%,0); }
						}
					</style>
					
					<img src="http://havasgroup.pe/wp-content/uploads/grupo-havas-footer.png" alt="GRUPO HAVAS" class="jhavasfooter" />
				<div class="wf-td">
