		...
		<div id="top-bar" role="complementary" <?php presscore_top_bar_class($hide_top_bar); ?>>
			...
			<div class="wf-wrap">
				...
				<div class="wf-container-top">
					...
					<div class="wf-table wf-mobile-collapsed" style="padding-top:20px;">
						<style>
							.jhavas{
							...
							@media screen and (max-width:1120px){
								.jhavas{
									position:static; display:block; margin:auto; padding-bottom: 10px; width:100%; max-width:340px;
								}
							}
						</style>

						<img src="http://havasgroup.pe/wp-content/uploads/grupo-havas.jpg" alt="GRUPO HAVAS" class="jhavas" />
