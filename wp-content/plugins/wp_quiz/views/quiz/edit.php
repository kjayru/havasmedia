<div class="wrap">
  <h2 id="add-new-user"> Edit Quiz</h2>
    ...
    <table class="form-table">
      <tbody>
        ...
        <tr class="form-field form-required">
          ...
          <td><input name="data[limit]" type="text" id="limit" value="<?php if($data['limit']) echo $data['limit']; else echo ''; ?>" aria-required="true">
            <br><span class="description">Set the number of questions will show on your quiz</span>
          </td>
        </tr>

        <tr class="form-field form-required">
          <th scope="row"><label for="hint">Number of hints <span class="description"></span></label></th>
          <td>
            <input name="data[hint]" type="text" id="hint" value="<?php echo intval($data['hint']);?>" aria-required="true">
        ...
        <tr class="form-field">
          ...
          <td>
            <select name="data[effect]" id="effect">
              <option <?php if($data['effect']=='slide') echo 'selected="selected"';?> value="slide">Slide</option>
              <option <?php if($data['effect']=='fade') echo 'selected="selected"';?> value="fade">Fade</option>
            </select>
          </td>
        </tr> -->
