...
ESSBOptionsStructureHelper::field_select('social', 'sharing-1', 'fullwidth_align', __('Choose alignment of network name', ESSB3_TEXT_DOMAIN), __('Provide different alignment of network name (counter when position inside or inside name). Default value is left.', ESSB3_TEXT_DOMAIN), array("left" => "Left", "center" => "Center", "right" => "Right"));
...
ESSBOptionsStructureHelper::field_select('social', 'sharing-3', 'twitter_counters', __('Counter type', ESSB3_TEXT_DOMAIN), __('Choose type of Tweet button count.'.$counter_redirect, ESSB3_TEXT_DOMAIN), $listOfOptions);
...
ESSBOptionsStructureHelper::field_switch('advanced', 'administrative', 'essb_encode_url', __('Use encoded version of url for sharing', ESSB3_TEXT_DOMAIN), __('Activate this option to encode url used for sharing. This is option is recommended when you notice that parts of shared url are missing - usually when additional options are used like campaign tracking.', ESSB3_TEXT_DOMAIN), '', __('Yes', ESSB3_TEXT_DOMAIN), __('No', ESSB3_TEXT_DOMAIN));
ESSBOptionsStructureHelper::field_switch('advanced', 'administrative', 'essb_encode_text', __('Use encoded version of texts for sharing', ESSB3_TEXT_DOMAIN), __('Activate this option to encode texts used for sharing. You need to use this option when you have special characters which does not appear in share.', ESSB3_TEXT_DOMAIN), '', __('Yes', ESSB3_TEXT_DOMAIN), __('No', ESSB3_TEXT_DOMAIN));
