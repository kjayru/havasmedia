    ...
    foreach ($tweets as $tweet) {
        ...
        <div class="aptf-single-tweet-wrapper">
            <div class="aptf-tweet-content">
                ...
                <div class="aptf-tweet-box-footer aptf-clearfix">
                    <span class="aptf-tweet-screenName"><i class="fa fa-twitter"></i> <?php echo $tweet->user->name; ?></span>
                    <?php
                    if ($aptf_pro_settings['display_username'] == 1) {
                        ?>
                ...
                <p>
                    <a href="http://twitter.com/'<?php echo $username; ?> " target="_blank"> <?php _e('Click here to read ' . $username . '\'S Twitter feed', APTF_TD_PRO); ?></a>
                </p>
                <?php
            }
            ?>
