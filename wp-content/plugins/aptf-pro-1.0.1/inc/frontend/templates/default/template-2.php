        ...
        foreach ($tweets as $tweet) {
            ...
            <div class="aptf-single-tweet-wrapper">
                <div class="aptf-tweet-content">
                    <?php if ($aptf_pro_settings['display_username'] == 1) { ?><a href="http://twitter.com/<?php echo $username; ?>" class="aptf-tweet-name" target="_blank"><?php echo $tweet->user->name; ?></a> <span class="aptf-tweet-username"><?php echo $username; ?></span> <?php } ?>
                    <div class="clear"></div>
                    <?php
                    if ($tweet->text) {
