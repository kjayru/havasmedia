            ...
            <div class="aptf-tweet-content">
                <?php if ($aptf_pro_settings['display_username'] == 1) { ?>
                    <a href="http://twitter.com/<?php echo $username; ?>" class="aptf-tweet-name" target="_blank">
                        <img src="<?php echo $tweet->user->profile_image_url; ?>" height="50px" width="50px"/>
                        <span class="aptf-screen-name"><?php echo $tweet->user->name; ?></span> <span class="aptf-user-name"><?php echo $username; ?></span>
                    </a>
                <?php } ?>
